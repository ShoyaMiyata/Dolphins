...
export default function GroupDetailPage() {
  ...
  const hasPendingRequest =
    joinRequests?.some((request) => request.user_id === currentUser?.id) ||
    false;
                  ...
                  <div className="flex items-center justify-between mt-2">
                    <div className="flex items-center gap-3 text-xs text-blue-600">
                      ...
                      <div className="flex items-center gap-1">
                        <Badge
                          variant="outline"
                          className="text-xs px-2 py-0 border-blue-200 text-blue-600"
                        >
                      ...
                      {isMember ? (
                        ...
                        <Button
                          onClick={() =>
                            joinGroup.mutate({
                              groupId,
                              joinType: group.join_type as "free" | "approval",
                            })
                          }
                          disabled={joinGroup.isPending}
                          size="sm"
                          className="text-xs h-8 px-4 bg-blue-600 hover:bg-blue-700 text-white transition-all duration-200"
                        >
                          {joinGroup.isPending ? (
                            <div className="flex items-center gap-2">
                              <Loader2 className="h-3 w-3 animate-spin" />
                        ...
                        <Button
                          ...
                          disabled={joinGroup.isPending}
                          size="sm"
                          className="text-xs h-8 px-4 bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 text-white transition-all duration-200"
                        >
                          {joinGroup.isPending ? (
                            <div className="flex items-center gap-2">
                              <Loader2 className="h-3 w-3 animate-spin" />
          ...
          <TabsContent value="posts" className="mt-4">
            ...
            {isPostsLoading ? (
              ...
              >
                <p>まだ投稿がありません</p>
                {isMember && (
                  <p className="text-sm mt-2">最初の投稿を作成しましょう</p>
                )}
              </motion.div>
            ) : (
              <div className="space-y-4">
                            ...
                            <div className="flex-1 min-w-0">
                              <div className="flex items-center gap-2 mb-2 flex-wrap">
                                ...
                                {isCurrentUser && (
                                  <Badge
                                    variant="outline"
                                    className="border-blue-300 text-blue-600 text-xs px-2 py-0"
                                  >
                                    あなた
                                  </Badge>
                                )}
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="flex flex-col gap-2">
                  <Button
                    ...
                    size="sm"
                    onClick={() =>
                      document.getElementById("group-icon-image-input")?.click()
                    }
                    className="text-sm"
                  >
                    アイコンを変更
            ...
            <div className="space-y-3 bg-white rounded-2xl p-4 border border-blue-100 shadow-sm">
              ...
              <div className="flex gap-2">
                <Button
                  ...
                  size="sm"
                  onClick={() =>
                    document.getElementById("group-cover-image-input")?.click()
                  }
                  className="text-sm"
                >
                  カバー画像を変更
          ...
          <div className="flex gap-2 pt-4 border-t flex-shrink-0">
            ...
            <Button
              onClick={() => {
                ...
                if (settingsForm.visibility_type !== group.visibility_type)
                  updates.visibility_type = settingsForm.visibility_type;
                if (settingsForm.join_type !== group.join_type)
                  updates.join_type = settingsForm.join_type;
