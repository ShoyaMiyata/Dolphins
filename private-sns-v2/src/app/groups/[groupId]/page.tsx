  ...
  return (
    <div className="bg-gradient-to-br from-blue-50 via-white to-sky-50 min-h-screen">
      ...
      <Dialog open={settingsDialogOpen} onOpenChange={setSettingsDialogOpen}>
        <DialogContent className="max-w-[calc(100vw-2rem)] w-full sm:max-w-lg max-h-[calc(100vh-20rem)] flex flex-col bg-gradient-to-br from-white via-blue-50 to-white border-0 shadow-2xl rounded-3xl overflow-hidden">
