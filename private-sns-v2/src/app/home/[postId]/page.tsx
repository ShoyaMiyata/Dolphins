...
import { ArrowLeft, Trash2, Edit, Heart } from 'lucide-react'
import { CommentInputForm, ReactionButton } from '@/components/features'
...
export default function PostDetailPage() {
  ...
  // Post-related state is now handled by PostCard
