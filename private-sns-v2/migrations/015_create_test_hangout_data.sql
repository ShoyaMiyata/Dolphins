...
VALUES
  ('63ed8b99-16e2-4251-bdda-cf3b84bc6a7e', 'カフェでランチしよう！', '駅前の新しいカフェが気になる！一緒にランチしませんか？', '駅前カフェ', '2025-01-15', '12:00', 'all', NOW() - INTERVAL '2 days'),
  ('38badf70-aa09-4ac0-99cf-8c3479e28b96', '映画見に行こう', '今週末の映画、誰か一緒に見ませんか？アクション映画が好きです！', '映画館', '2025-01-18', '14:30', 'all', NOW() - INTERVAL '1 day'),
  ('63ed8b99-16e2-4251-bdda-cf3b84bc6a7e', 'ボードゲーム会', '家でボードゲームしませんか？新しいゲーム買ったのでみんなで遊びましょう！', '自宅', '2025-01-20', '19:00', 'all', NOW() - INTERVAL '6 hours'),
  ('38badf70-aa09-4ac0-99cf-8c3479e28b96', 'ジョギングパートナー募集', '朝のジョギング、一緒に走りませんか？コースは公園周りです', '公園', '2025-01-22', '06:30', 'all', NOW() - INTERVAL '3 hours'),
  ('63ed8b99-16e2-4251-bdda-cf3b84bc6a7e', '料理教室参加しませんか？', '料理が好きなので、一緒に新しいレシピに挑戦しましょう！', 'キッチンスタジオ', '2025-01-25', '10:00', 'all', NOW() - INTERVAL '1 hour');
